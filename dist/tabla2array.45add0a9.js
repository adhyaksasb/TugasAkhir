...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"tabla2array.js":[function(require,module,exports) {
/**
          ...
          for (var k = 0; k < myTabla.childNodes[i].childNodes[j].childNodes.length; k++) {
            if (myTabla.childNodes[i].childNodes[j].childNodes[k].nodeName == "TD") {
              ...
              if (cont == 0) {
                ...
                if (myTabla.childNodes[i].childNodes[j].childNodes[k].innerHTML.trim() != "") myVectorAux.push(parseFloat(myTabla.childNodes[i].childNodes[j].childNodes[k].innerHTML.trim()));else myVectorAux.push(0);
              }
...
},{}]},{},["C:/Users/adshi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tabla2array.js"], null)
//# sourceMappingURL=/tabla2array.45add0a9.js.map